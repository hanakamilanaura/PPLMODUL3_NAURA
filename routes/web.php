...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/edit-note-page/{id}', [NoteController::class, 'edit'])->middleware('auth');
    Route::put('/edit-note-page/{id}', [NoteController::class, 'update'])->name('note-update')->middleware('auth');
